...
@section('contenido')
        ...
        <div class="mt-10">
            ...
            <h2 class="text-center text-xl text-sky-500 uppercase">Mensaje enviado por {{ $contacto->name}}</h2>
                ...
                <div class=" mt-5 bg-white border border-gray-300 shadow-xl md:w-7/12 mx-auto p-6 rounded-xl">
                    <div class="">
                        <p class=" flex items-center gap-3 text-gray-500  font-semibold">
                            Nombre:
                            <span class="font-normal  text-gray-700"> {{$contacto->name}}</span>
                        </p>
                    ...
                    <div class="mt-3">
                        <p class=" flex items-center gap-3 text-gray-500  font-semibold">
                            E-mail:
                            <span class="font-normal  text-gray-700"> {{$contacto->email}}</span>
                        </p>
                    ...
                    <div class="mt-3 ">
                        <p class=" flex items-center gap-3 text-gray-500  font-semibold">
                            Asunto:
                            <span class="font-normal  text-gray-700"> {{$contacto->asunto}}</span>
                        </p>
                    ...
                    <div class="mt-3 ">
                        <p class=" flex gap-3 text-gray-500  font-semibold">
                            Mensaje:
                            <span class="font-normal  text-gray-700"> {{$contacto->mensaje}}</span>
                        </p>
                    ...
                    <div class="mt-3 ">
                        <p class=" flex items-center gap-3 text-gray-500  font-semibold">
                            Mensaje enviado:
                            <span class="font-normal  text-gray-700"> {{$contacto->created_at->diffForHumans()}}</span>
                        </p>
                    ...
                    <div class="mt-7 flex flex-col-reverse md:flex-row md:justify-between md:items-center">
                        ...
                        <form method="POST" action=" {{ route('contacto.destroy', $contacto) }} ">
